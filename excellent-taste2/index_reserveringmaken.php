...
<html lang="nl">
	...
	<body>
		...
		<div class="reservering-text">
			<p>Reservering maken:</p>
		</div>

		<div class="reservering-Maken">
				<form method="post">
					Tafel:<br>
					<input type="text" name="Tafel" required> <p>

					Datum:<br>
					<input type="text" name="Datum" required> <p>
		...
		if (isset($_POST['reserveringSubmit'])) {
			...
			$sql = "INSERT INTO reservering (`Tafel`,`Datum`,`Tijd`,`Klant_ID`,`Aantal`,`Aantal_k`,`Allergieen`,`Opmerking`)
